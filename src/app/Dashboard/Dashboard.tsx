  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="settings" element={<Settings valueCards={dashboard.valueCards} trustCards={dashboard.trustCards} extensions={dashboard.extensions} extensionTemplates={dashboard.extensionTemplates} isLoading={dashboard.isLoading} />} />
